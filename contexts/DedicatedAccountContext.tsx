...
const mockAccounts: DedicatedAccount[] = [
    { id: 'acc_1', owner_id: 'cust_1', owner_type: 'Customer', owner_name: 'مشتری نمونه ۱', bank_name: 'ملت', account_holder: 'صرافی الشیخ (برای مشتری ۱)', account_number: '111111', balance: 4622700, currency: Currency.IRT_BANK, created_at: new Date() },
    { id: 'acc_2', owner_id: 'part_1', owner_type: 'Partner', owner_name: 'همکار نمونه هرات', bank_name: 'صادرات', account_holder: 'صرافی الشیخ (برای همکار هرات)', account_number: '222222', balance: 7960000, currency: Currency.IRT_BANK, created_at: new Date() },
    { id: 'acc_3', owner_id: 'cust_2', owner_type: 'Customer', owner_name: 'مشتری ویژه تهران', bank_name: 'ملی', account_holder: 'صرافی الشیخ (مشتری تهران)', account_number: '333333', balance: 13679000, currency: Currency.IRT_BANK, created_at: dayBefore },
    { id: 'acc_4', owner_id: 'part_2', owner_type: 'Partner', owner_name: 'همکار کابل', bank_name: 'تجارت', account_holder: 'صرافی الشیخ (همکار کابل)', account_number: '444444', balance: 6420000, currency: Currency.IRT_BANK, created_at: dayBefore },
];
...
const mockTransactions: DedicatedAccountTransaction[] = [
    ...
    { id: 'tx_5', account_id: 'acc_1', type: 'deposit', amount: 250000, commission_amount: 0, total_deducted: 250000, timestamp: new Date(now.getTime() - 1000 * 60 * 30), created_by: 'ادمین سیستم', source_bank: 'پاسارگاد', source_account: '202-303', receipt_serial: 'ASD-5' },
    ...
    { id: 'tx_10', account_id: 'acc_4', type: 'deposit', amount: 2500000, commission_amount: 0, total_deducted: 2500000, timestamp: yesterday, created_by: 'ادمین سیستم', source_bank: 'کشاورزی', source_account: '456-789', receipt_serial: 'RTY-10' },

    // --- DAY BEFORE YESTERDAY'S TRANSACTIONS ---
    { id: 'tx_1', account_id: 'acc_1', type: 'deposit', amount: 5000000, commission_amount: 0, total_deducted: 5000000, timestamp: dayBefore, created_by: 'مدیر کل', source_bank: 'ملی', source_account: '123-456', receipt_serial: 'ABC-1' },
    { id: 'tx_4', account_id: 'acc_2', type: 'deposit', amount: 10000000, commission_amount: 0, total_deducted: 10000000, timestamp: dayBefore, created_by: 'مدیر کل', source_bank: 'تجارت', source_account: '777-888', receipt_serial: 'TYU-4' },
    { id: 'tx_new_1', account_id: 'acc_3', type: 'deposit', amount: 15000000, commission_amount: 0, total_deducted: 15000000, timestamp: dayBefore, created_by: 'مدیر کل', source_bank: 'سپه', source_account: '333-444', receipt_serial: 'DFG-12' },
    { id: 'tx_new_2', account_id: 'acc_4', type: 'deposit', amount: 8000000, commission_amount: 0, total_deducted: 8000000, timestamp: dayBefore, created_by: 'مدیر کل', source_bank: 'مسکن', source_account: '555-666', receipt_serial: 'HJK-13' },
];
